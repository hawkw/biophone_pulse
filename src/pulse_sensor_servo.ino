...
//int fadeRate = NUMPIXELS;                 // used to fade LED on with PWM on fadePin
int pos;
...
void loop(){
  ...
  if (QS == true){
//        fadeRate = NUMPIXELS;         // Makes the LED Fade Effect Happen
...
//    fadeRate = constrain(fadeRate,0,NUMPIXELS);   //  keep LED fade value from going into negative numbers!
